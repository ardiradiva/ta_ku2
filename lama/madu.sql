...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Apr 2022 pada 10.06
...
INSERT INTO `nilai` (`id_nilai`, `id_supplier`, `id_users`, `rasa`, `aroma`, `warna`, `aksesibilitas`, `packaging`, `konsistensi`, `harga`, `fleksibilitas`, `garansi`, `jarak`, `lokasi`, `legalitas`, `manajerial`, `komunikasi`) VALUES
(7, 1, 1, 4, 3, 1, 4, 2, 3, 2, 2, 4, 2, 4, 4, 3, 4),
(8, 2, 1, 3, 4, 2, 4, 2, 3, 3, 2, 2, 4, 4, 4, 4, 3);
